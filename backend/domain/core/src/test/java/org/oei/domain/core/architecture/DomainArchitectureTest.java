package org.oei.domain.core.architecture;
 ...
 */
@AnalyzeClasses(packages = {"org.oei.domain.core", "org.oei.domain.shared"}, importOptions = ImportOption.DoNotIncludeTests.class)
class DomainArchitectureTest {

    @ArchTest
    static final ArchRule domain_must_not_depend_on_spring =
            noClasses().that().resideInAPackage("org.oei.domain..")
