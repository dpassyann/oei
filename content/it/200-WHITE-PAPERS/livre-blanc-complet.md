...
```mermaid
flowchart TB
    subgraph HAUT["Ciò che si disciplina: gli oggetti tecnici"]
        direction LR
        A1["Protocolli<br/>RFC · IETF · W3C"]
        A2["Sicurezza<br/>ISO/IEC 27001 · OWASP"]
        A3["Sicurezza critica<br/>DO-178C · IEC 62304 · ISO 26262"]
    end
    subgraph BAS["Ciò che non si disciplina: le persone"]
        direction LR
        B1["Nessun titolo<br/>richiesto"]
        B2["Nessuna deontologia<br/>opponibile"]
        B3["Nessuna formazione<br/>continua richiesta"]
    end
    HAUT -. "lo stesso professionista<br/>progetta il sistema critico" .-> BAS
```
...
```mermaid
flowchart LR
    F["Formazione<br/>iniziale"] --> C["Certificazione<br/>indipendente"]
    C --> D["Deontologia<br/>comune"]
    D --> FC["Formazione<br/>continua"]
    FC --> T(("Fiducia"))
    T -. "mantiene e<br/>rinnova" .-> FC
```
...
```mermaid
flowchart LR
    P["Praticante<br/>fondamentali,<br/>sotto supervisione"] --> I["Ingegnere<br/>progettazione autonoma<br/>di componenti"]
    I --> A["Architetto<br/>coerenza di<br/>sistemi interi"]
    A --> E["Esperto<br/>riferimento su<br/>domini sensibili"]
    E --> ES["Esperto senior<br/>responsabilità critica<br/>e trasmissione"]
    ES --> FE["Fellow<br/>contributo duraturo<br/>ed eminente"]
```
