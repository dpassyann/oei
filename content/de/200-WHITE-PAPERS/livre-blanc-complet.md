...
```mermaid
flowchart TB
    subgraph HAUT["Was reglementiert wird: die technischen Objekte"]
        direction LR
        A1["Protokolle<br/>RFC · IETF · W3C"]
        A2["Sicherheit<br/>ISO/IEC 27001 · OWASP"]
        A3["Kritische Sicherheit<br/>DO-178C · IEC 62304 · ISO 26262"]
    end
    subgraph BAS["Was nicht reglementiert wird: die Personen"]
        direction LR
        B1["Kein erforderlicher<br/>Titel"]
        B2["Keine verbindliche<br/>Berufsethik"]
        B3["Keine erforderliche<br/>Weiterbildung"]
    end
    HAUT -. "dieselbe Fachperson<br/>entwirft das kritische System" .-> BAS
```
...
```mermaid
flowchart LR
    F["Grund-<br/>ausbildung"] --> C["Unabhängige<br/>Zertifizierung"]
    C --> D["Gemeinsame<br/>Berufsethik"]
    D --> FC["Kontinuierliche<br/>Weiterbildung"]
    FC --> T(("Vertrauen"))
    T -. "pflegt und<br/>erneuert" .-> FC
```
...
```mermaid
flowchart LR
    P["Praktiker<br/>Grundlagen,<br/>unter Aufsicht"] --> I["Ingenieur<br/>eigenständige Konzeption<br/>von Komponenten"]
    I --> A["Architekt<br/>Kohärenz<br/>ganzer Systeme"]
    A --> E["Experte<br/>Referenz für<br/>sensible Bereiche"]
    E --> ES["Senior-Experte<br/>kritische Verantwortung<br/>und Wissensweitergabe"]
    ES --> FE["Fellow<br/>dauerhafter und<br/>herausragender Beitrag"]
```
