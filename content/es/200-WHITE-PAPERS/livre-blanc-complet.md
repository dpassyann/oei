---
title: "Libro Blanco — Por un reconocimiento progresivo de la profesión informática"
version: "v4"
status: "versión 4 — aplica el nuevo nombre oficial no generizado de la organización, Orden Internacional de Expertos en Informática (OEI), en favor del nombre de la disciplina y no de una persona con género marcado; conserva por lo demás las clarificaciones de la versión 3.1"
date: "2026-08-13"
---
...
Fundador de la iniciativa Orden Internacional de Expertos en Informática (OEI)
...
*La Orden Internacional de Expertos en Informática (OEI) es un movimiento fundador, respaldado por una asociación, y no una orden profesional en el sentido legal del término (véase la nota preliminar). Su razón de ser se resume en una visión, una misión y un conjunto de valores.*
...
```mermaid
flowchart TB
    subgraph HAUT["Lo que se regula: los objetos técnicos"]
        direction LR
        A1["Protocolos<br/>RFC · IETF · W3C"]
        A2["Seguridad<br/>ISO/IEC 27001 · OWASP"]
        A3["Seguridad crítica<br/>DO-178C · IEC 62304 · ISO 26262"]
    end
    subgraph BAS["Lo que no se regula: las personas"]
        direction LR
        B1["Ningún título<br/>exigido"]
        B2["Ninguna deontología<br/>exigible"]
        B3["Ninguna formación<br/>continua requerida"]
    end
    HAUT -. "el mismo profesional<br/>diseña el sistema crítico" .-> BAS
```
...
```mermaid
flowchart LR
    F["Formación<br/>inicial"] --> C["Certificación<br/>independiente"]
    C --> D["Deontología<br/>común"]
    D --> FC["Formación<br/>continua"]
    FC --> T(("Confianza"))
    T -. "mantiene y<br/>renueva" .-> FC
```
...
```mermaid
flowchart LR
    P["Practicante<br/>fundamentos,<br/>bajo supervisión"] --> I["Ingeniero<br/>diseño autónomo<br/>de componentes"]
    I --> A["Arquitecto<br/>coherencia de<br/>sistemas completos"]
    A --> E["Experto<br/>referencia en<br/>ámbitos sensibles"]
    E --> ES["Experto senior<br/>responsabilidad crítica<br/>y transmisión"]
    ES --> FE["Fellow<br/>contribución duradera<br/>y eminente"]
```
...
Al unirme a la Orden Internacional de Expertos en Informática en calidad de miembro fundador, me comprometo a:
