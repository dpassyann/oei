...
```mermaid
flowchart TB
    subgraph HAUT["What is governed: technical artefacts"]
        direction LR
        A1["Protocols<br/>RFC · IETF · W3C"]
        A2["Security<br/>ISO/IEC 27001 · OWASP"]
        A3["Critical safety<br/>DO-178C · IEC 62304 · ISO 26262"]
    end
    subgraph BAS["What is not governed: people"]
        direction LR
        B1["No title<br/>required"]
        B2["No enforceable<br/>code of ethics"]
        B3["No continuing<br/>education required"]
    end
    HAUT -. "the same professional<br/>designs the critical system" .-> BAS
```
...
```mermaid
flowchart LR
    F["Initial<br/>training"] --> C["Independent<br/>certification"]
    C --> D["Shared<br/>ethics"]
    D --> FC["Continuing<br/>education"]
    FC --> T(("Trust"))
    T -. "maintains and<br/>renews" .-> FC
```
...
```mermaid
flowchart LR
    P["Practitioner<br/>fundamentals,<br/>under supervision"] --> I["Engineer<br/>autonomous design<br/>of components"]
    I --> A["Architect<br/>coherence of<br/>entire systems"]
    A --> E["Expert<br/>reference in<br/>sensitive domains"]
    E --> ES["Senior Expert<br/>critical responsibility<br/>and mentoring"]
    ES --> FE["Fellow<br/>lasting, eminent<br/>contribution"]
```
