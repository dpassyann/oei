...
// Final French PDF, generated by `scripts/generate-livre-blanc-pdf.mjs` from
// `content/fr/200-WHITE-PAPERS/livre-blanc-complet.md` into
// `.prompt/Livre-Blanc-OEI-v4.pdf` and `public/assets/livre-blanc/livre-blanc-oei-v4.pdf`.
const LIVRE_BLANC_PDF_HREF_FR = '/assets/livre-blanc/livre-blanc-oei-v4.pdf';

// English White Paper, provided directly (not generated by the PDF script) — served as the
// download for every non-French UI language, since there is no per-language generated PDF yet.
const LIVRE_BLANC_PDF_HREF_EN = '/assets/livre-blanc/White-Paper-IOITE.pdf';
...
export class LivreBlanc {
  ...
  // French readers get the native French PDF; every other UI language downloads the English
  // White Paper (the only translated PDF available today) rather than a French PDF they can't
  // read.
  protected readonly pdfHref = computed(() =>
    this.i18n.currentLang() === 'fr' ? LIVRE_BLANC_PDF_HREF_FR : LIVRE_BLANC_PDF_HREF_EN,
  );
